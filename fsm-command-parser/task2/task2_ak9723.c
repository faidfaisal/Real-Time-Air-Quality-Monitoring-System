 ...
 * Provides byte-write and block-read transactions, sensor initialisation,
 * overcurrent detection, and raw-ADC-to-millivolt conversion with sprintf
 * formatting into the SerLCD display buffers.
 */
...
extern char dsp_buff1[];
extern char dsp_buff2[];
extern char dsp_buff3[];
extern char dsp_buff4[];

/* ── Low-level TWI helpers ──────────────────────────────────────────────── */
